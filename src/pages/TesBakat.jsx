...
function TesBakat() {
  ...
  return (
    <div className="min-h-screen bg-[#6E0292] flex flex-col pb-20">
      <div className="py-5 sticky top-0 bg-[#6E0292] z-10">
        <ArrowBack link="/bakat" />
        <h2 className="text-xl font-bold text-center text-white">Temukan</h2>
        <h2 className="text-xl text-center text-white">Bakat</h2>
      </div>
      <div className="bg-[#9A4EB3] flex-grow flex justify-center pt-2 overflow-y-auto">
