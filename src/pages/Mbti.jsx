...
import gambar from "../assets/mbti.png";
...
function Mbti() {
  ...
  return (
    <div className="min-h-screen bg-fitur1 flex flex-col overflow-y-auto">
      <div className="py-5">
        <ArrowBack link="/home" />
      ...
      <div className="w-9/12 bg-white kontol rounded-2xl mx-auto flex items-center justify-center p-2 -mt-2 ">
        <p className="text-lg text-center font-semibold">
          <span className="font-bold">Tes Kepribadian</span> adalah alat
